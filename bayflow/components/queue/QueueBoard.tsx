                ...
                <Droppable droppableId={col.id}>
                  {(provided, snapshot) => (
                    <div
                      ...
                      className={`flex-1 overflow-y-auto min-h-[150px] flex flex-col gap-0 transition-colors rounded-2xl
                        ${col.id === 'in_bay' ? 'bg-slate-100/50 p-3 border-2 border-dashed border-slate-200' : ''}
