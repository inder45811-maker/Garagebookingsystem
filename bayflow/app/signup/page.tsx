    ...
    <div className="flex min-h-screen font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-blue-100 text-base leading-relaxed">Join hundreds of UK garages modernizing their reception desk. Start your free 14-day trial today.</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 lg:text-left">
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Start Your Free Trial</h1>
            <p className="text-sm text-slate-500 mt-1">Modernize your garage workflow today.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05)] p-8">
            <form className="space-y-5">
              <div className="space-y-2">
                ...
                <input placeholder="Joe's Garage" className={inputClass} />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Email</label>
                <input type="email" placeholder="admin@garage.com" className={inputClass} />
              </div>
              <div className="space-y-2">
              ...
              <button
                type="submit"
                className="w-full h-12 rounded-xl bg-primary text-white font-bold text-sm hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 flex items-center justify-center"
              >
                Create Account
              </button>
            </form>
